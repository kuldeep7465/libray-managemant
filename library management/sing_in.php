...
<body class="image">
   ...
   <div class="container ">
    <div class="row">
        <div class="col-lg-8">
<form action="sing_code.php" method="post" class="border my-4 p-4 bg-white text-dark">
  <p class="text-dark">Studant Sing in Page</p>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" name="institut" class="form-control" id="exampleInputPassword1">
  </div>
  <div class="mb-3">
